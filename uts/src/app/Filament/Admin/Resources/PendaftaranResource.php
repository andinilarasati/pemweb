        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('status')
                    ->required(),
                Forms\Components\TextInput::make('dokumen_khs')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('dokumen_penghasilan')
                    ->maxLength(255)
                    ->default(null),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('dokumen_khs')
                    ->searchable(),
                Tables\Columns\TextColumn::make('dokumen_penghasilan')
                    ->searchable(),
